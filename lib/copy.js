...
export const faq = {
  ...
  items: [
    {
      q: "Is Anticipation a romance?",
      a: "Not in the way the word usually promises. It's literary fiction — a love story told through restraint and consequence, closer to a quiet tragedy than a happy ending. If you read for the ache more than the resolution, it's for you.",
    },
    {
      q: "What is the book actually about?",
      a: "A man who had eight weeks to say the thing that mattered, and spent them waiting. It's about timing, regret, and the small silences that decide a life — the cost of being careful when you should have been brave.",
    },
    {
      q: "When does it release?",
      a: "Winter 2026. Readers on the list get the Prologue and full Chapter One now, and hear about the release date, the cover, and early copies before anyone else.",
    },
    {
      q: "What do I get when I sign up?",
      a: "The Prologue and the complete Chapter One, delivered to your inbox — plus the occasional note from me as the book finds its way into the world. No spam, and one-click unsubscribe.",
    },
    {
      q: "Who is Jey Lofton?",
      a: "A filmmaker and first-time novelist. I came to fiction through a camera, and it shows — the prose is spare, visual, cut to the bone. A military background lives in the discipline of it. Anticipation is my debut.",
    },
    {
      q: "Why does it read the way it does?",
      a: "Because I write the way I shoot: short scenes, hard cuts, nothing that hasn't earned its place. It's cinematic by instinct, not by accident — built to be felt as much as read.",
    },
  ],
};
