...
export const reveal = {
  ...
  imageAlt: "A bloodstained, wax-sealed envelope resting on a dark surface.",
};

export const divider = {
  imageAlt: "A city skyline at dusk with a single empty chair facing the view.",
};
...
export const lastDoor = {
  ...
  imageAlt: "An open ring box beside a single glass of wine on a dark table.",
};
