 ...
 * you never need to touch a .tsx file to change wording.
 *
 * Convention: text wrapped between {em} ... {/em} renders in italic ember.
...
export const hero = {
  ...
  // Title is split into roman + italic-ember halves.
  titleRoman: "Antici",
  titleItalic: "pation",
  ...
  scrollCue: "Scroll",
  imageAlt:
    "A man alone on a city balcony at night, the skyline burning low behind him.",
} as const;

export const question = {
  eyebrow: "The Prologue",
  // {em} marks the phrases highlighted in ember.
  quote:
...
export const reveal = {
  ...
  imageAlt:
    "A bloodstained, wax-sealed envelope resting on a dark surface.",
} as const;

export const divider = {
  imageAlt:
    "A city skyline at dusk with a single empty chair facing the view.",
} as const;
...
export const about = {
  ...
  signature: "— Jey",
  portraitAlt: "Portrait of author Jey Lofton.",
} as const;
...
export const lastDoor = {
  ...
  imageAlt:
    "An open ring box beside a single glass of wine on a dark table.",
} as const;
